...
# Auth Service - Run with direct RabbitMQ (local development)

echo "Starting Auth Service (Direct RabbitMQ)..."
echo "Service will be available at: http://localhost:8004"
echo ""

# Kill any process using port 8004 (prevents "address already in use" errors)
PORT=8004
