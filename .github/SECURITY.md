...
The Auth Service is the primary authentication and authorization component of the xshopai platform. It handles user authentication, session management, social login integration, multi-factor authentication, and authorization tokens. This service is the security foundation for the entire platform.
